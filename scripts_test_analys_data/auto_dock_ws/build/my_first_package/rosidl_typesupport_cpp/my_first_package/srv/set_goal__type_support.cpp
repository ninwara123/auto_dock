...
static const _SetGoal_Request_type_support_symbol_names_t _SetGoal_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_first_package, srv, SetGoal_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_first_package, srv, SetGoal_Request)),
  }
};
...
{
  return &::my_first_package::srv::rosidl_typesupport_cpp::SetGoal_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_first_package, srv, SetGoal_Request)() {
  return get_message_type_support_handle<my_first_package::srv::SetGoal_Request>();
}
...
static const _SetGoal_Response_type_support_symbol_names_t _SetGoal_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_first_package, srv, SetGoal_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_first_package, srv, SetGoal_Response)),
  }
};
...
{
  return &::my_first_package::srv::rosidl_typesupport_cpp::SetGoal_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_first_package, srv, SetGoal_Response)() {
  return get_message_type_support_handle<my_first_package::srv::SetGoal_Response>();
}
...
static const _SetGoal_type_support_symbol_names_t _SetGoal_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_first_package, srv, SetGoal)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_first_package, srv, SetGoal)),
  }
};
...
{
  return &::my_first_package::srv::rosidl_typesupport_cpp::SetGoal_service_type_support_handle;
}

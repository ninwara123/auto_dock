...
#include "my_first_package/srv/detail/set_goal__rosidl_typesupport_fastrtps_c.h"
...
using _SetGoal_Request__ros_msg_type = my_first_package__srv__SetGoal_Request;
...
size_t get_serialized_size_my_first_package__srv__SetGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetGoal_Request__ros_msg_type * ros_message = static_cast<const _SetGoal_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SetGoal_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_first_package__srv__SetGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_first_package
size_t max_serialized_size_my_first_package__srv__SetGoal_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_my_first_package__srv__SetGoal_Request(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_first_package, srv, SetGoal_Request)() {
...
using _SetGoal_Response__ros_msg_type = my_first_package__srv__SetGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_first_package
size_t get_serialized_size_my_first_package__srv__SetGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetGoal_Response__ros_msg_type * ros_message = static_cast<const _SetGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_first_package__srv__SetGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_first_package
size_t max_serialized_size_my_first_package__srv__SetGoal_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_my_first_package__srv__SetGoal_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_first_package, srv, SetGoal_Response)() {
...
// already included above
// #include "my_first_package/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "my_first_package/srv/set_goal.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_first_package, srv, SetGoal)() {

...
auto_dock_package__srv__RandGoal_Request__create()
{
  ...
  auto_dock_package__srv__RandGoal_Request * msg = (auto_dock_package__srv__RandGoal_Request *)allocator.allocate(sizeof(auto_dock_package__srv__RandGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(auto_dock_package__srv__RandGoal_Request));
  bool success = auto_dock_package__srv__RandGoal_Request__init(msg);
  if (!success) {
...
auto_dock_package__srv__RandGoal_Request__destroy(auto_dock_package__srv__RandGoal_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    auto_dock_package__srv__RandGoal_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
auto_dock_package__srv__RandGoal_Request__Sequence__init(auto_dock_package__srv__RandGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  auto_dock_package__srv__RandGoal_Request * data = NULL;

  if (size) {
    data = (auto_dock_package__srv__RandGoal_Request *)allocator.zero_allocate(size, sizeof(auto_dock_package__srv__RandGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = auto_dock_package__srv__RandGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        auto_dock_package__srv__RandGoal_Request__fini(&data[i - 1]);
      }
...
auto_dock_package__srv__RandGoal_Request__Sequence__fini(auto_dock_package__srv__RandGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      auto_dock_package__srv__RandGoal_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  auto_dock_package__srv__RandGoal_Request__Sequence * array = (auto_dock_package__srv__RandGoal_Request__Sequence *)allocator.allocate(sizeof(auto_dock_package__srv__RandGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = auto_dock_package__srv__RandGoal_Request__Sequence__init(array, size);
  if (!success) {
...
auto_dock_package__srv__RandGoal_Request__Sequence__destroy(auto_dock_package__srv__RandGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    auto_dock_package__srv__RandGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
auto_dock_package__srv__RandGoal_Request__Sequence__are_equal(const auto_dock_package__srv__RandGoal_Request__Sequence * lhs, const auto_dock_package__srv__RandGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!auto_dock_package__srv__RandGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  auto_dock_package__srv__RandGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(auto_dock_package__srv__RandGoal_Request);
    auto_dock_package__srv__RandGoal_Request * data =
      (auto_dock_package__srv__RandGoal_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!auto_dock_package__srv__RandGoal_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          auto_dock_package__srv__RandGoal_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!auto_dock_package__srv__RandGoal_Request__copy(
...
auto_dock_package__srv__RandGoal_Response__init(auto_dock_package__srv__RandGoal_Response * msg)
{
  ...
  if (!geometry_msgs__msg__Point__init(&msg->position)) {
    auto_dock_package__srv__RandGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  auto_dock_package__srv__RandGoal_Response * msg = (auto_dock_package__srv__RandGoal_Response *)allocator.allocate(sizeof(auto_dock_package__srv__RandGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(auto_dock_package__srv__RandGoal_Response));
  bool success = auto_dock_package__srv__RandGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
auto_dock_package__srv__RandGoal_Response__Sequence__init(auto_dock_package__srv__RandGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  auto_dock_package__srv__RandGoal_Response * data = NULL;

  if (size) {
    data = (auto_dock_package__srv__RandGoal_Response *)allocator.zero_allocate(size, sizeof(auto_dock_package__srv__RandGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = auto_dock_package__srv__RandGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        auto_dock_package__srv__RandGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
auto_dock_package__srv__RandGoal_Response__Sequence__fini(auto_dock_package__srv__RandGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      auto_dock_package__srv__RandGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  auto_dock_package__srv__RandGoal_Response__Sequence * array = (auto_dock_package__srv__RandGoal_Response__Sequence *)allocator.allocate(sizeof(auto_dock_package__srv__RandGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = auto_dock_package__srv__RandGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
auto_dock_package__srv__RandGoal_Response__Sequence__destroy(auto_dock_package__srv__RandGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    auto_dock_package__srv__RandGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
auto_dock_package__srv__RandGoal_Response__Sequence__are_equal(const auto_dock_package__srv__RandGoal_Response__Sequence * lhs, const auto_dock_package__srv__RandGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!auto_dock_package__srv__RandGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  auto_dock_package__srv__RandGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(auto_dock_package__srv__RandGoal_Response);
    auto_dock_package__srv__RandGoal_Response * data =
      (auto_dock_package__srv__RandGoal_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!auto_dock_package__srv__RandGoal_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          auto_dock_package__srv__RandGoal_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!auto_dock_package__srv__RandGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }

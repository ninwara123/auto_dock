...
class Metaclass_SetGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from auto_dock_package.srv import _set_goal
...
class SetGoal(metaclass=Metaclass_SetGoal):
    from auto_dock_package.srv._set_goal import SetGoal_Request as Request
    from auto_dock_package.srv._set_goal import SetGoal_Response as Response

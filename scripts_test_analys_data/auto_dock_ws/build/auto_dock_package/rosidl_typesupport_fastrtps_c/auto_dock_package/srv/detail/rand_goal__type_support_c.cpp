...
#include "auto_dock_package/srv/detail/rand_goal__rosidl_typesupport_fastrtps_c.h"
...
using _RandGoal_Request__ros_msg_type = auto_dock_package__srv__RandGoal_Request;
...
size_t get_serialized_size_auto_dock_package__srv__RandGoal_Request(
  const void * untyped_ros_message,
...
static uint32_t _RandGoal_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_auto_dock_package__srv__RandGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_auto_dock_package
size_t max_serialized_size_auto_dock_package__srv__RandGoal_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_auto_dock_package__srv__RandGoal_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, auto_dock_package, srv, RandGoal_Request)() {
...
using _RandGoal_Response__ros_msg_type = auto_dock_package__srv__RandGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_auto_dock_package
size_t get_serialized_size_auto_dock_package__srv__RandGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RandGoal_Response__ros_msg_type * ros_message = static_cast<const _RandGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_auto_dock_package__srv__RandGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_auto_dock_package
size_t max_serialized_size_auto_dock_package__srv__RandGoal_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_auto_dock_package__srv__RandGoal_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, auto_dock_package, srv, RandGoal_Response)() {
...
// already included above
// #include "auto_dock_package/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "auto_dock_package/srv/rand_goal.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, auto_dock_package, srv, RandGoal)() {

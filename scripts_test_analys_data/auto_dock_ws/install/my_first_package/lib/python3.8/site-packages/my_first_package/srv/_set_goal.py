...
class Metaclass_SetGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from my_first_package.srv import _set_goal
...
class SetGoal(metaclass=Metaclass_SetGoal):
    from my_first_package.srv._set_goal import SetGoal_Request as Request
    from my_first_package.srv._set_goal import SetGoal_Response as Response
